 ...
 */
package se.inera.intyg.logsender.stub;
...
import se.inera.intyg.logsender.stub.json.LogStoreObjectMapper;
...
public class ChronicleLogStore {
    ...
    public void init() {
        ...
        LOG.info("Loading logstore from file path: " + file.getAbsolutePath());
        try {
